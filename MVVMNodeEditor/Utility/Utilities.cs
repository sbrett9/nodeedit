namespace MVVMNodeEditor.Utility
{
    ...
    public static class Utilities
    {
        ...
        public static bool WillClip(FrameworkElement element, Vector displacement, FrameworkElement container)
        {
            Point p = element.TranslatePoint(new Point(0, 0), container);
            Rect bounds = new Rect(p, new Size(element.ActualWidth, element.ActualHeight));
            bounds.Offset(displacement);
            Rect rect = new Rect(0.0, 0.0, container.ActualWidth, container.ActualHeight);
            bool j = rect.Contains(bounds.TopLeft) && rect.Contains(bounds.BottomRight);
            return !j;
        }

        public static bool IsClipped(FrameworkElement element, FrameworkElement container)
        {
