namespace MvvmLight13.Controls
{
    ...
    public class NodeItem : ListBoxItem
    {
        ...
        /// </summary>
        internal NodeView ParentOperationView
        {
            get { return (NodeView) GetValue(ParentOperationViewProperty); }
            set { SetValue(ParentOperationViewProperty, value); }
        }
        ...
        {
            if (ParentOperationView == null)
            {
                return;
            }

            int maxZ = ParentOperationView.FindMaxZIndex();
            ZIndex = maxZ + 1;
        }
        ...
        protected override void OnMouseDown(MouseButtonEventArgs e)
        {
            ...
            if (ParentOperationView != null)
            {
                ParentOperationView.Focus();
            }

            if (e.ChangedButton == MouseButton.Left && ParentOperationView != null)
            {
                lastMousePoint = e.GetPosition(ParentOperationView);
            ...
            else if (e.ChangedButton == MouseButton.Right && ParentOperationView != null)
            {
        ...
        internal void LeftMouseDownSelectionLogic()
        {
            ...
            else
            {
                ...
                if (ParentOperationView.SelectedNodes.Count == 0)
                {
                    //
                ...
                else if (ParentOperationView.SelectedNodes.Contains(this) ||
                         ParentOperationView.SelectedNodes.Contains(DataContext))
                {
                    // 
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            if (isDragging)
            {
                ...
                var curMousePoint = e.GetPosition(ParentOperationView);
            ...
            else if (isLeftMouseDown && ParentOperationView.EnableNodeDragging)
            {
                //
        ...
        internal void LeftMouseUpSelectionLogic()
        {
            ...
            else
            {
                ...
                if (ParentOperationView.SelectedNodes.Count == 1 &&
                    (ParentOperationView.SelectedNode == this ||
                     ParentOperationView.SelectedNode == DataContext))
                {
                    //
