namespace MvvmLight13.Controls
{
    ...
    /// <summary>
    /// Partial definition of the NodeView class.
    ...
    public partial class NodeView
    {
        ...
        private bool DetermineConnectorItemDraggedOver(Point hitPoint, out ConnectorItem connectorItemDraggedOver, out object connectorDataContextDraggedOver)
        {
            ...
            var connectorItem = Utilities.FindVisualParentWithType<ConnectorItem>(hitItem);
            if (connectorItem == null)
            {
                return false;
            }

            var NodeView = connectorItem.ParentNodeView;
            if (NodeView != this)
            {
                //
                // Ensure that dragging over a connector in another NodeView doesn't
